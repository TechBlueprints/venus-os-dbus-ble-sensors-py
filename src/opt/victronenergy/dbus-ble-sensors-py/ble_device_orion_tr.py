...
# Single in-flight guard for provisioning: the writer's slot serialises
# the GATT work; this only stops the advertisement handler queueing
# another attempt while one is pending.
